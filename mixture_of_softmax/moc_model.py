...
class MocWordPredictor(object):
    ...
    def __init__(self, vocab_size, mixture_components):
        ...
        with self.g.as_default():
            with tf.variable_scope(NAMESPACE):
                ...
                self.outputs = tf.nn.softmax(tf.reduce_sum(tf.multiply(self.hw_matrix, self.pi_values), axis=0))
    ...
    def load(self, filename, vocab_size, mixture_components):
        model = MocWordPredictor(vocab_size, mixture_components)
