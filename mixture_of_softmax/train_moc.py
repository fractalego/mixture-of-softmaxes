...
from mixture_of_softmax.moc_model import MocWordPredictor
...
if __name__ == '__main__':
    ...
    nn_model = MocWordPredictor(word_to_one_hot.get_length(), mixture_components=_mixture_components)
    train(data, nn_model, word_to_one_hot, _saving_dir, num_samples=20000, prefix='moc-', epochs=49, bucket_size=_bucket_size, trace_every=1)
